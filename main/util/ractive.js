...
(function (global, factory) {
  ...
  var isClient = !!doc;
  var isJsdom =
    typeof navigator !== "undefined" && /jsDom/.test(navigator.appName);
  var hasConsole =
      ...
      for (prop in from) {
        if (hasOwn.call(from, prop)) {
          if (hasOwn.call(to, prop)) {
            ...
            interpolators[prop] =
              interpolate(from[prop], to[prop]) || snap(to[prop]);
          } else {
  ...
  Hook.prototype.fire = function fire(ractive, arg) {
    ...
    if (
      !ractive[this.method] &&
      this.deprecate &&
      this.call(this.deprecate.deprecated, ractive, arg)
    ) {
  ...
  function Ractive$animate(keypath, to, options) {
    ...
    return protoAnimate(
      this,
      this.viewmodel.joinAll(splitKeypathI(keypath)),
      to,
      options
    );
  }
  ...
  Query.prototype.cancel = function cancel() {
    var liveQueries =
      this._root[
        this.isComponentQuery ? "liveComponentQueries" : "liveQueries"
      ];
  ...
  Query.prototype.remove = function remove(nodeOrComponent) {
    var index = this.result.indexOf(
      this.isComponentQuery ? nodeOrComponent.instance : nodeOrComponent
    );
  ...
  Query.prototype.update = function update() {
    this.result.sort(
      this.isComponentQuery ? sortByItemPosition : sortByDocumentPosition
    );
    this.dirty = false;
  };
  ...
  function getWildcardNames(eventName) {
    if (wildcardCache.hasOwnProperty(eventName)) {
      ...
      return (wildcardCache[eventName] =
        getPotentialWildcardMatches(eventName));
    }
  }
  ...
  function notifySubscribers(ractive, subscribers, event, args) {
    ...
    for (var i = 0, len = subscribers.length; i < len; i += 1) {
      if (
        !subscribers[i].off &&
        subscribers[i].apply(ractive, args) === false
      ) {
        stopEvent = true;
      }
    }
  ...
  function resolveAmbiguousReference(fragment, ref) {
    ...
    while (fragment) {
      ...
      if (
        ((aliases = fragment.owner.aliases) || (aliases = fragment.aliases)) &&
        ...
        if (fragment.context.has(key)) {
          if (crossedComponentBoundary) {
            return localViewmodel
              .createLink(key, fragment.context.joinKey(keys.shift()), key)
              .joinAll(keys);
          }
  ...
  ModelBase.prototype.addShuffleRegister = function addShuffleRegister(
    item,
    stage
  ) {
    if (stage === void 0) stage = "early";
  ...
  ModelBase.prototype.clearUnresolveds = function clearUnresolveds(
    specificKey
  ) {
    var this$1 = this;
  ...
  ModelBase.prototype.getKeypath = function getKeypath(ractive) {
    ...
    if (!this.keypath) {
      this.keypath = this.parent.isRoot
        ? this.key
  ...
  ModelBase.prototype.rebinding = function rebinding(next, previous, safe) {
    ...
    var i = this.deps.length;
    while (i--) {
      if (this$1.deps[i].rebinding)
        this$1.deps[i].rebinding(next, previous, safe);
    }
  ...
  ModelBase.prototype.registerPatternObserver =
    function registerPatternObserver(observer) {
      this.patternObservers.push(observer);
      this.register(observer);
    };

  ModelBase.prototype.registerTwowayBinding = function registerTwowayBinding(
    binding
  ) {
    this.bindings.push(binding);
  };

  ModelBase.prototype.removeUnresolved = function removeUnresolved(
    key,
    resolver
  ) {
  ...
  ModelBase.prototype.unregisterPatternObserver =
    function unregisterPatternObserver(observer) {
      removeFromArray(this.patternObservers, observer);
      this.unregister(observer);
    };

  ModelBase.prototype.unregisterTwowayBinding =
    function unregisterTwowayBinding(binding) {
      removeFromArray(this.bindings, binding);
    };

  ModelBase.prototype.updateFromBindings = function updateFromBindings$1(
    cascade
  ) {
    var this$1 = this;
  ...
  KeyModel.prototype.addShuffleRegister =
  ...
  var LinkModel = (function (ModelBase) {
    ...
    LinkModel.prototype.animate = function animate(
      from,
      to,
      options,
      interpolator
    ...
    LinkModel.prototype.shuffle = function shuffle(newIndices) {
      ...
      if (!this.target.shuffling) {
        ...
        while (i--) {
          ...
          if (i in this$1.childByKey)
            this$1.childByKey[i].rebinding(
              !~idx ? undefined : this$1.joinKey(idx),
              this$1.childByKey[i],
              true
            );

          if (!~idx && this$1.keyModels[i]) {
            this$1.keyModels[i].rebinding(
              undefined,
              this$1.keyModels[i],
              false
            );
  ...
  var Model = (function (ModelBase) {
    ...
    Model.prototype.animate = function animate(
      from,
      to,
      options,
      interpolator
    ...
    Model.prototype.applyValue = function applyValue(value) {
      ...
      if (this.key === "length" && isArray(this.parent.value))
        this.parent.length = this.parent.value.length;
    };
    ...
    Model.prototype.get = function get(shouldCapture, opts) {
      ...
      return (shouldCapture || (opts && opts.unwrap)) && this.wrapper
        ? this.wrapper.value
        : this.value;
    };
  ...
  function resolveReference(fragment, ref) {
    ...
    // ancestor references
    if (ref[0] === "~")
      return fragment.ractive.viewmodel.joinAll(splitKeypathI(ref.slice(2)));
    if (ref[0] === ".") {
      var parts = ref.split("/");
  ...
  function gatherRefs(fragment) {
    ...
    while (fragment) {
      if (
        fragment.parent &&
        (fragment.parent.indexRef || fragment.parent.keyRef)
      ) {
  ...
  function Ractive$update(keypath) {
    ...
    return update$2(
      this,
      keypath ? this.viewmodel.joinAll(keypath) : this.viewmodel
    );
  }
  ...
  function keypath() {
    warnOnceIfDebug(
      "Object property keypath is deprecated, please use resolve() instead."
    );
    return this.resolve();
  }
  ...
  function rootpath() {
    warnOnceIfDebug(
      "Object property rootpath is deprecated, please use resolve( ractive.root ) instead."
    );
  ...
  function context() {
    warnOnceIfDebug(
      "Object property context is deprecated, please use get() instead."
    );
    return this.get();
  }
  ...
  function index() {
    warnOnceIfDebug(
      'Object property index is deprecated, you can use get( "indexName" ) instead.'
    );
  ...
  function key() {
    warnOnceIfDebug(
      'Object property key is deprecated, you can use get( "keyName" ) instead.'
    );
  ...
  function link$1(there, here) {
    if (
      here === there ||
      (there + ".").indexOf(here + ".") === 0 ||
      (here + ".").indexOf(there + ".") === 0
    ) {
    ...
    this.viewmodel
      .joinAll(splitKeypathI(here))
      .link(model || this.viewmodel.joinAll(sourcePath), there);
  ...
  var ReferenceResolver = function ReferenceResolver(
    fragment,
    reference,
    callback
  ) {
  ...
  function observe(keypath, callback, options) {
    ...
    if (isObject(keypath)) {
      ...
      keypaths.forEach(function (keypath) {
        observers.push(
          createObserver(this$1, keypath, callback, options || {})
        );
      });
    }
    ...
    if (!this.dirty || this.changed.length) {
      ...
      if (!this.changed.length) {
        ...
        var ok = this.baseModel.isRoot
          ...
          : this.changed.map(function (keys) {
              return (
                this$1.baseModel.getKeypath(this$1.ractive) +
                "." +
                keys.map(escapeKey).join(".")
              );
            });
  ...
  function observeList(keypath, callback, options) {
    if (typeof keypath !== "string") {
      throw new Error(
        "ractive.observeList() must be passed a string as its first argument"
      );
    }
  ...
  function Ractive$on(eventName, callback) {
    ...
    eventNames.forEach(function (eventName) {
      (this$1._subs[eventName] || (this$1._subs[eventName] = [])).push(
        callback
      );
    });
  ...
  var cssConfigurator = {
    ...
    extend: function (Parent, proto, options) {
      ...
      var id = uuid();
      var styles = options.noCssTransform
        ? options.css
        : transformCss(options.css, id);
      ...
      if (result && result.constructor === Object) {
        for (var prop in result) {
          if (typeof result[prop] === "function")
            result[prop] = bind(result[prop], ractive);
        }
      }
  ...
  function readReference(parser) {
    ...
    if (name === "@keypath" || name === "@rootpath") {
      if (parser.matchPattern(specialCall)) {
        ...
        if (!ref)
          parser.error("Expected a valid reference for a keypath expression");

        parser.allowWhitespace();

        if (!parser.matchString(")"))
          parser.error("Unclosed keypath expression");
        name += "(" + ref.n + ")";
      }
    }
    ...
    return {
      ...
      n:
        (spread ? "..." : "") +
        reference.replace(/^this\./, "./").replace(/^this$/, "."),
    };
  }
  ...
  var specialsPattern = new RegExp(
    "^(?:" + Object.keys(specials$1).join("|") + ")"
  );
  var numberPattern$1 =
    /^(?:[+-]?)(?:(?:(?:0|[1-9]\d*)?\.\d+)|(?:(?:0|[1-9]\d*)\.)|(?:0|[1-9]\d*))(?:[eE][+-]?\d+)?/;
  ...
  function processDirective(tokens, parentParser, type) {
      ...
      if (type === EVENT && (match = methodCallPattern.exec(tokens))) {
        warnIfDebug(
          parentParser.getContextMessage(
            pos,
            "Unqualified method events are deprecated. Prefix methods with '@this.' to call methods on the current Ractive instance."
          )[2]
        );
      ...
      if (type === EVENT && ~tokens.indexOf("(")) {
        ...
        if (parser$1.result && parser$1.result[0]) {
          if (parser$1.remaining().length) {
            parentParser.pos =
              pos + tokens.length - parser$1.remaining().length;
            parentParser.error(
              "Invalid input after event expression '" +
                parser$1.remaining() +
                "'"
            );
          }
        ...
        if (
          ...
          parentParser.error(
            "Invalid input in event expression '" + tokens + "'"
          );
        }
      }
    ...
    if (!directiveName.length) {
      ...
      result = {
        ...
        n:
          directiveName.length === 1 && typeof directiveName[0] === "string"
            ? directiveName[0]
            : directiveName,
      };
  ...
  function readAttributeOrDirective(parser) {
    ...
    if ((directive = directives[attribute.n])) {
      ...
      if (directive.t === TRANSITION || directive.t === DECORATOR)
    ...
    while (i--) {
      ...
      if (item.f) {
        ...
        if (!preserveWhitespaceInsideFragment) {
          ...
          if (
            !nextItem ||
            (typeof nextItem === "string" && leadingWhitespace$1.test(nextItem))
          ) {
  ...
  function readPartialDefinitionSection(parser) {
    ...
    do {
      ...
      if (
        ...
        if (!child.r === "partial") {
          parser.error(
            "Expected " + delimiters[0] + "/partial" + delimiters[1]
          );
        }
  ...
  var ExpressionProxy = (function (Model) {
    ...
    ExpressionProxy.prototype.rebinding = function rebinding(
      next,
      previous,
      safe
    ) {
  ...
  var ReferenceExpressionChild = (function (Model) {
    ...
    ReferenceExpressionChild.prototype = Object.create(
  ...
  var ReferenceExpressionProxy = (function (Model) {
    ...
    ReferenceExpressionProxy.prototype.forceResolution =
    ...
    ReferenceExpressionProxy.prototype.handleChange =
    ...
    ReferenceExpressionProxy.prototype.set = function set(value) {
      if (!this.model)
        throw new Error(
          "Unresolved reference expression. This should not happen!"
        );
  ...
  function resolveAliases(section) {
    if (section.template.z) {
      ...
      for (var i = 0; i < refs.length; i++) {
        section.aliases[refs[i].n] = resolve$2(
          section.parentFragment,
          refs[i].x
        );
      }
    }
  ...
  var Alias = (function (Item) {
    ...
    Alias.prototype.findAllComponents = function findAllComponents(
      name,
      query
    ) {
      if (this.fragment) {
  ...
  function findElement(start, orComponent) {
    ...
    while (
      start &&
      start.type !== ELEMENT &&
      (!orComponent || start.type !== COMPONENT)
    ) {
  ...
  var remove = /\/\*(?:[\s\S]*?)\*\//g;
  var escape =
    /url\(\s*(['"])(?:\\[\s\S]|(?!\1).)*\1\s*\)|url\((?:\\[\s\S]|[^)])*\)|(['"])(?:\\[\s\S]|(?!\1).)*\2/gi;
  var value = /\0(\d+)/g;
  ...
  function updateId(reset) {
    ...
    if (this.ractive.nodes[node.id] === node)
  ...
  function createOrWrapDescriptor(
    originalDescriptor,
    ractive,
    keypath,
    wrapper
    ...
    if (originalDescriptor.set && originalDescriptor.set.__magic) {
      originalDescriptor.set.__magic.dependants.push({
        ractive: ractive,
        keypath: keypath,
      });
  ...
  var MagicWrapper = function MagicWrapper(ractive, value, keypath) {
    ...
    Object.keys(value).forEach(function (key) {
      ...
      var childKeypath = keypath
        ? "" + keypath + "." + escapeKey(key)
        : escapeKey(key);

      var descriptor = createOrWrapDescriptor(
        originalDescriptor,
        ractive,
        childKeypath,
        this$1
    ...
    Object.keys(this.value).forEach(function (key) {
      ...
      if (descriptor.set.__magic.dependants.length === 1) {
        Object.defineProperty(
          this$1.value,
          key,
          descriptor.set.__magic.originalDescriptor
        );
      }
    });
  };
  ...
  var magicArrayAdaptor = {
    filter: function (object, keypath, ractive) {
      return (
        magicAdaptor$1.filter(object, keypath, ractive) &&
        arrayAdaptor.filter(object)
      );
    },
  ...
  var Computation = (function (Model) {
    ...
    Computation.prototype.setDependencies = function setDependencies(
      dependencies
    ) {
  ...
  var RootModel = (function (Model) {
    ...
    RootModel.prototype.createLink = function createLink(
      keypath,
      target,
      targetPath
    ) {
    ...
    RootModel.prototype.has = function has(key) {
      ...
      if (
        ...
        (this.childByKey[key] && this.childByKey[key]._link)
      )
        return true;
  ...
  function getAdaptors(ractive, protoAdapt, options) {
    ...
    var modifyArrays =
      "modifyArrays" in options ? options.modifyArrays : ractive.modifyArrays;
  ...
  var EventDirective = function EventDirective(options) {
    ...
    if (this.element.type === COMPONENT) {
      ...
      this.template.n.split("-").forEach(function (n) {
        ...
        this$1.events.push(
          fn
            ? new CustomEvent(fn, this$1.element)
            : new DOMEvent(n, this$1.element)
        );
      });
    }
      ...
      this.models = template.x.r.map(function (ref, i) {
        ...
        if (specialMatch) {
          ...
          return {
            ...
            keys: specialMatch[2]
              ? splitKeypathI(specialMatch[2].substr(1))
              : [],
          };
        }
        ...
        if (dollarMatch) {
          ...
          return {
            ...
            keys: [dollarMatch[1] - 1].concat(
              dollarMatch[2] ? splitKeypathI(dollarMatch[2].substr(1)) : []
            ),
          };
        }
  ...
  var Component = (function (Item) {
    ...
    Component.prototype.findAllComponents = function findAllComponents(
      name,
      query
    ) {
      if (query.test(this)) {
  ...
  Decorator.prototype.bind = function bind() {
    ...
    if (this.template.f.a && this.template.f.a.s) {
      ...
      this.argsFn = getFunction(
        this.template.f.a.s,
        this.template.f.a.r.length
      );
    }
  };
  ...
  Decorator.prototype.render = function render() {
    ...
    runloop.scheduleTask(function () {
      ...
      if (this$1.argsFn) {
        ...
        args = this$1.dynamicArgs
          ? this$1.argsFragment.getArgsList()
          : this$1.args;
      }

      this$1.intermediary = fn.apply(
        this$1.ractive,
        [this$1.node].concat(args)
      );
      ...
      if (nameChanged || !this.intermediary.update) {
        ...
        if (this.dynamicArgs) {
          ...
          this.intermediary.update.apply(
            this.ractive,
            this.argsFn.apply(this.ractive, args$1)
          );
        } else {
  ...
  function warnAboutAmbiguity(description, ractive) {
    warnOnceIfDebug(
      "The " +
        description +
        " being used for two-way binding is ambiguous, and may cause unexpected results. Consider initialising your data to eliminate the ambiguity",
      { ractive: ractive }
    );
  }
  ...
  var Binding = function Binding(element, name) {
    ...
    if (!model) {
      ...
      warnAboutAmbiguity(
        "'" + interpolator.template.r + "' reference",
        this.ractive
      );
  ...
  var ContentEditableBinding = (function (Binding) {
    ...
    ContentEditableBinding.prototype = Object.create(
      Binding && Binding.prototype
    );
    ContentEditableBinding.prototype.constructor = ContentEditableBinding;

    ContentEditableBinding.prototype.getInitialValue =
  ...
  var MultipleSelectBinding = (function (Binding) {
    ...
    MultipleSelectBinding.prototype = Object.create(
      Binding && Binding.prototype
    );
    ...
    MultipleSelectBinding.prototype.getInitialValue =
      function getInitialValue() {
  ...
  var NumericBinding = (function (GenericBinding) {
    ...
    NumericBinding.prototype = Object.create(
  ...
  function selectBinding(element) {
    ...
    if (
      ...
      isBindable(attributes.contenteditable)
    ) {
  ...
  var Element = (function (Item) {
    function Element(options) {
      ...
      while (i--) {
        ...
        if (attr.name === "type")
          this$1.attributes.unshift(this$1.attributes.splice(i, 1)[0]);
    ...
    Element.prototype.findAllComponents = function findAllComponents(
      name,
      query
    ) {
      if (this.fragment) {
  ...
  var Mustache = (function (Item) {
    ...
    Mustache.prototype.bind = function bind() {
      ...
      if (model) {
        ...
        this.resolver = this.parentFragment.resolve(
          this.template.r,
          function (model) {
            this$1.model = model;
            model.register(this$1);
      ...
      if (!item.model) {
        warnOnceIfDebug(
          "The " +
            ...
            "='{{" +
            template[0].r +
            "}}' mapping is ambiguous, and may cause unexpected results. Consider initialising your data to eliminate the ambiguity",
  ...
  var Partial = (function (Mustache) {
    ...
    Partial.prototype.bind = function bind() {
      ...
      if (!template) {
        ...
        if (
          ...
          (typeof templateObj.template === "string" || isArray(templateObj.t))
        ) {
          ...
          (!this.model || typeof this.model.get() !== "string") &&
          this.refName
        ) {
    ...
    Partial.prototype.findAllComponents = function findAllComponents(
      name,
      query
    ) {
      this.fragment.findAllComponents(name, query);
      ...
      if (this.dirty) {
        ...
        if (!this.named) {
          ...
          if (
            ...
            (typeof template.template === "string" || isArray(template.t))
          ) {
            if (
              template.t !== this.source &&
  ...
  RepeatedFragment.prototype.createIteration = function createIteration(
    key,
    index
  ) {
  ...
  RepeatedFragment.prototype.findAllComponents = function findAllComponents(
    name,
    query
  ) {
    var this$1 = this;
  ...
  RepeatedFragment.prototype.rebinding = function rebinding(next) {
    ...
    this.iterations.forEach(function (fragment) {
      var model = next
        ? next.joinKey(fragment.key || fragment.index)
        : undefined;
  ...
  var Section = (function (Mustache) {
    ...
    Section.prototype.findAllComponents = function findAllComponents(
      name,
      query
    ) {
      if (this.fragment) {
  ...
  if (!isClient) {
    ...
    createTransitions = function (t, to, options, changedProperties, resolve) {
      ...
      setTimeout(function () {
        ...
        style[TRANSITION_PROPERTY] = changedProperties
          .map(prefix$1)
          .map(hyphenate)
          .join(",");
        style[TRANSITION_TIMING_FUNCTION] = hyphenate(
          options.easing || "linear"
        );
        style[TRANSITION_DURATION] = options.duration / 1000 + "s";

        function transitionEndHandler(event) {
          var index = changedProperties.indexOf(
            camelCase(unprefix(event.propertyName))
          );
            ...
            new Ticker({
              ...
              step: function (pos) {
                ...
                while (i--) {
                  ...
                  t.node.style[prop.name] =
                    prop.interpolator(pos) + prop.suffix;
                }
              },
              complete: function () {
  ...
  var getComputedStyle =
    win && (win.getComputedStyle || legacy.getComputedStyle);
  ...
  Transition.prototype.animateStyle = function animateStyle(
    style,
    value,
    options
  ) {
  ...
  Transition.prototype.bind = function bind() {
    ...
    if (options.template) {
      if (options.template.v === "t0" || options.template.v == "t1")
        this.element._introTransition = this;
      if (options.template.v === "t0" || options.template.v == "t2")
        this.element._outroTransition = this;
  ...
  Transition.prototype.processParams = function processParams(
    params,
    defaults
  ) {
  ...
  Transition.prototype.registerCompleteHandler =
  ...
  Transition.prototype.unregisterCompleteHandler =
  ...
  var Triple = (function (Mustache) {
    ...
    Triple.prototype.toString = function toString() {
      return this.model && this.model.get() != null
        ? decodeCharacterReferences("" + this.model.get())
        : "";
    };
  ...
  var Yielder = (function (Item) {
    ...
    Yielder.prototype.bind = function bind() {
      ...
      (
        this.component.yielders[name] || (this.component.yielders[name] = [])
      ).push(this);
    ...
    Yielder.prototype.findAllComponents = function findAllComponents(
      name,
      queryResult
    ) {
  ...
  function createItem(options) {
    ...
    if (options.template.t === ELEMENT) {
      ...
      var ComponentConstructor = getComponentConstructor(
  ...
  Fragment.prototype.findAllComponents = function findAllComponents(
    name,
    query
  ) {
    var this$1 = this;
  ...
  function Ractive$teardown() {
    ...
    var promise = this.fragment.rendered
      ? this.unrender()
      : Promise$1.resolve();
